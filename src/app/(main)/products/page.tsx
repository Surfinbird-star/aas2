...
export default function ProductsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="bg-blue-100 p-4 rounded-md mb-6 flex justify-center items-center border-2 border-blue-200">
        <p className="font-semibold text-blue-800 text-lg">Товаров в корзине: {cart.reduce((sum, item) => sum + item.quantity, 0)}</p>
      </div>
